...
public interface IAlarmMgr  {
    ...
    public static interface ICallback {
         ...
         * @brief 告警标记完成回调
         * @param errCode : 结果错误码，0表示成功
         * @param markedIdList : 标记的告警信息Id列表
         */
         ...
         * @brief 查询告警图片完成事件
         * @param errCode : 结果错误码，0表示成功
         * @param imageId : 查询的 Image ID
         * @param alarmImage : 查询到的告警图片信息
         */
        default void onAlarmImageQueryDone(int errCode, final String imageId,
         ...
         * @param alarmVideo : 查询到的告警云录视频信息
         */
        default void onAlarmVideoQueryDone(int errCode, final String deviceID, long timestamp,
    ...
    /**
     * @brief 根据 ImageId 来查询告警Image信息，触发 onAlarmImageQueryDone() 回调
     * @param imageId : 要查询的ImageId
     * @return 错误码
     */
    int queryImageById(final String imageId);
