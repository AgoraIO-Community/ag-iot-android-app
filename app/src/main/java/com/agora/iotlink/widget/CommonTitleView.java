package com.agora.iotlink.widget;
...
import com.agora.iotlink.R.styleable;
import com.agora.iotlink.databinding.ViewCommonTitleBinding;
import com.agora.iotlink.utils.NotchUtils;
...
public final class CommonTitleView extends ConstraintLayout {
    ...
    private final void initView(AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray var11 = var10000.getTheme().obtainStyledAttributes(attrs, styleable.titleView, defStyleAttr, 0);
        ...
        int centerTextColor = typedArray.getColor(R.styleable.titleView_ctv_centerTextColor, ContextCompat.getColor(this.getContext(), R.color.def_text_color));
